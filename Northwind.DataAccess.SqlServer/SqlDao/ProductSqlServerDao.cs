...
namespace Northwind.DataAccess.SqlServer.SqlDao
{
    ...
    /// </summary>
    public sealed class ProductSqlServerDao : IProductDAO
    {
        private readonly SqlConnection connection;

        /// <summary>
        /// Initializes a new instance of the <see cref="ProductSqlServerDao"/> class.
        /// </summary>
        /// <param name="connection">A <see cref="SqlConnection"/>.</param>
        public ProductSqlServerDao(SqlConnection connection)
        {
...
SELECT @@ROWCOUNT";
        ...
        public async Task<ProductTransferObject> FindProductAsync(int productId)
        {
            ...
            await using var command = new SqlCommand("SelectOneProduct", this.connection)
            {
...
FETCH FIRST {1} ROWS ONLY";
        ...
        /// <inheritdoc/>
        public IAsyncEnumerable<ProductTransferObject> SelectProductsByNameAsync(ICollection<string> productNames)
        {
