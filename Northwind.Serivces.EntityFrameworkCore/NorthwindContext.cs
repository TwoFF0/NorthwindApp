...
namespace Northwind.Serivces.EntityFrameworkCore
{
    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Services.Employees.Employee> Employees { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToView("CategoryEntity Sales for 1997");
            });

            modelBuilder.Entity<CurrentProductList>(entity =>
            {
                entity.ToView("Current ProductEntity List");
            ...
            modelBuilder.Entity<EmployeeTerritory>(entity =>
            {
                ...
                entity.HasOne(d => d.EmployeeEntity)
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.ProductEntity)
                    .WithMany(p => p.OrderDetails)
            ...
            modelBuilder.Entity<ProductEntity>(entity =>
            {
                ...
                entity.HasOne(d => d.CategoryEntity)
            ...
            {
                entity.ToView("ProductEntity Sales for 1997");
            });
            ...
            {
                entity.ToView("Products by CategoryEntity");
            });
            ...
            {
                entity.ToView("Sales by CategoryEntity");
            });
